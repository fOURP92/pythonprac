...
pygame.display.set_caption('The snake of InKa..')
...
def gameLoop():
    ...
    lead_x = display_width / 2 #Lead = lead of blocks = head of the snake.
    ...
    while not gameExit:
        ...
        while gameOver == True:
            ...
            #Message and event handling if you lose. Restart or quit.
